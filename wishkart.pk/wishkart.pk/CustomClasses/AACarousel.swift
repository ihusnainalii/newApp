...
public class AACarousel: UIView,UIScrollViewDelegate {
    ...
    fileprivate func setPageControlFrame() {
        ...
        case .topLeft:
            ...
            break
        case .bottomLeft:
            pageControl.frame = CGRect.init(x: (8 * images.count) + 10, y: Int(scrollView.frame.size.height - 20), width: 0, height: 0)
            break
        case .topRight:
            pageControl.frame = CGRect.init(x: Int(scrollView.frame.size.width) - 8 * images.count, y: 5, width: 0, height: 10)
            break
        case .bottomRight:
            pageControl.frame = CGRect.init(x: Int(scrollView.frame.size.width) - 13 * images.count, y: Int(scrollView.frame.size.height - 20), width: 0, height: 0)
            break
        default:
